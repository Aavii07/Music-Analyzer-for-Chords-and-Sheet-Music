...
class VirtualKeyboard(tk.Frame):
    ...
    def highlight_key(self, note, highlight=True):
        ...
        note_to_key = {
            ...
            'C#1': 'Bl3', 'D#1': 'Bl4', 'E#1': 'Wh6', 'F#1': 'Bl6', 'G#1': 'Bl7', 'A#1': 'Bl8', 'B#1': 'Wh10',
            'D-1': 'Bl3', 'E-1': 'Bl4', 'F-1': 'Wh5', 'G-1': 'Bl6', 'A-1': 'Bl7', 'B-1': 'Bl8', 'C-1': 'Wh2',
            'Db1': 'Bl3', 'Eb1': 'Bl4', 'Fb1': 'Wh5', 'Gb1': 'Bl6', 'Ab1': 'Bl7', 'Bb1': 'Bl8', 'Cb1': 'Wh2',
            
            # Octave 2
            'C2': 'Wh10', 'D2': 'Wh11', 'E2': 'Wh12', 'F2': 'Wh13', 'G2': 'Wh14', 'A2': 'Wh15', 'B2': 'Wh16',
            'C#2': 'Bl10', 'D#2': 'Bl11', 'E#2': 'Wh13', 'F#2': 'Bl13', 'G#2': 'Bl14', 'A#2': 'Bl15', 'B#2': 'Wh17',
            ...
            # Octave 3
            'C3': 'Wh17', 'D3': 'Wh18', 'E3': 'Wh19', 'F3': 'Wh20', 'G3': 'Wh21', 'A3': 'Wh22', 'B3': 'Wh23',
            'C#3': 'Bl17', 'D#3': 'Bl18', 'E#3': 'Wh20', 'F#3': 'Bl20', 'G#3': 'Bl21', 'A#3': 'Bl22', 'B#3': 'Wh24',
            ...
            # Octave 4
            'C4': 'Wh24', 'D4': 'Wh25', 'E4': 'Wh26', 'F4': 'Wh27', 'G4': 'Wh28', 'A4': 'Wh29', 'B4': 'Wh30',
            'C#4': 'Bl24', 'D#4': 'Bl25', 'E#4': 'Wh27', 'F#4': 'Bl27', 'G#4': 'Bl28', 'A#4': 'Bl29', 'B#4': 'Wh31',
            ...
            'C#5': 'Bl31', 'D#5': 'Bl32', 'E#5': 'Wh34', 'F#5': 'Bl34', 'G#5': 'Bl35', 'A#5': 'Bl36', 'B#5': 'Wh38',
            ...
            # Octave 6
            'C6': 'Wh38', 'D6': 'Wh39', 'E6': 'Wh40', 'F6': 'Wh41', 'G6': 'Wh42', 'A6': 'Wh43', 'B6': 'Wh44',
            'C#6': 'Bl38', 'D#6': 'Bl39', 'E#6': 'Wh41', 'F#6': 'Bl41', 'G#6': 'Bl42', 'A#6': 'Bl43', 'B#6': 'Wh45',
            ...
            'C#7': 'Bl45', 'D#7': 'Bl46', 'E#7': 'Wh48', 'F#7': 'Bl48', 'G#7': 'Bl49', 'A#7': 'Bl50', 'B#7': 'Wh52',
        ...
        if note in note_to_key:
            key_id = self.keys.get(note_to_key[note])
            if key_id:
                if highlight:
                    color = 'yellow'
